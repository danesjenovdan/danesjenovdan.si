...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0013_alter_blogpage_modules_alter_modularpage_modules_and_more'),
    ]
