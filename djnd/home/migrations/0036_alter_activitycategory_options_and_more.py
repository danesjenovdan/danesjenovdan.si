...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='projects',
            field=wagtail.fields.StreamField([('project', wagtail.blocks.StructBlock([('name', wagtail.blocks.CharBlock(label='Ime')), ('description', wagtail.blocks.CharBlock(label='Opis')), ('image', wagtail.images.blocks.ImageChooserBlock(label='Ikona')), ('url', wagtail.blocks.URLBlock(label='Zunanja povezava', required=False)), ('page', wagtail.blocks.PageChooserBlock(label='Podstran', required=False))], label='Projekt'))], blank=True, null=True, use_json_field=True, verbose_name='Projekti'),
        ),
        migrations.AlterField(
            model_name='promoted',
            name='activity',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='home.activity', verbose_name='Aktivnost'),
        ),
        migrations.AlterField(
            model_name='promoted',
            name='description',
        ...
        migrations.AlterField(
            model_name='promoted',
            name='title',
            field=models.TextField(blank=True, help_text='Če so polja prazna in obstaja Aktivnost, se uporabijo podatki Aktivnosti', verbose_name='Naslov'),
        ),
    ]
