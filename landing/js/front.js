...
$(document).ready(function() {
	...
	$('.pravica').on('click', function() {
		if (!$('.pravicatooltip').hasClass('open')) {
			$(this).parents('.container').next().addClass('open').addClass('tooltip' + $('#' + $(this).data('href')).data('tooltip'));
			$('#' + $(this).data('href')).fadeIn(1000);
			$(this).parents('.container').next().data('href', $(this).data('href'));
		} else {
			$(this).parents('.container').next().removeClass('tooltip' + $('#' + $(this).parents('.container').next().data('href')).data('tooltip'));
			$(this).parents('.container').next().addClass('tooltip' + $('#' + $(this).data('href')).data('tooltip'));
			$('#' + $(this).parents('.container').next().data('href')).fadeOut(400);
			$('#' + $(this).data('href')).delay(600).fadeIn(400);
			$(this).parents('.container').next().data('href', $(this).data('href'));
		}
	});
	
	$('.tooltipclose').on('click', function() {
		$(this).parent().removeClass('open').removeClass('tooltip' + $(this).siblings('#' + $(this).parent().data('href')).data('tooltip'));
		$(this).siblings('#' + $(this).parent().data('href')).fadeOut(400);
	});
