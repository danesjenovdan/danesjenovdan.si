<template>
  <div>
    <page-title :title="$t('menu.about')" :text="$t('about.description')" color="primary" />
    <div class="row">
      <div class="col-xl-7">
      ...
      <div class="col-xl-5 about-info__contact-col">
        <div class="about-info__contact">
          ...
          <div class="icon">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52" fill="currentColor">
              <path
              ...
              />
              <path d="M25.135 29.131L3.443 24.15l.448-1.949 20.175 4.633 9.384-18.29 1.78.914z" />
              <path
          ...
          <div class="text">
            <strong>
              <a href="tel:+38664147823" target="_blank" rel="noopener noreferrer">+386 64 147 823</a>
            </strong>
          </div>
        </div>
      </div>
