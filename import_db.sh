...
DATABASE_NAME="danesjenovdan_si"
K8S_NAMESPACE="danesjenovdan"
SECRETS_NAME="danesjenovdan-secrets"
...
# docker container exec -i $(docker compose ps -q db) psql -U danesjenovdan_si danesjenovdan_si < db.dump
